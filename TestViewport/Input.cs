...
namespace WindViewer.Editor
{
    public class Input
    {
        ...
        internal static void Internal_UpdateInputState()
        {
            ...
            //Console.WriteLine("mousePos: {0}, {1}, delta: {2}, {3}", MousePosition.X, MousePosition.Y, MouseDelta.X, MouseDelta.Y);
        }
        ...
        {
            Vector3 incrimentalDelta = new Vector3(mousePos) - MousePosition;
            MouseDelta += incrimentalDelta;
