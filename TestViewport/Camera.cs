...
namespace TestViewport
{
        public class Camera
        {
            ...
            {
                Matrix4 viewProj = GetViewProjMatrix();

                Vector4 point = Vector4.Transform(new Vector4(worldPos, 1), viewProj);
                ...
                screenPoint.X = ((result.X + 1) / 2f) * Display.Width;
                screenPoint.Y = (((1-result.Y) + 1) / 2f) * Display.Height;
